...
export default function EssayResultPage() {
  ...
  if (loading && !essay) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-[#0b0f1a] gap-4">
  ...
  if (!essay) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-[#0b0f1a] text-red-400 p-6 text-center">
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0">
      ...
      <div className="bg-[#0e1320] border-b border-white/5 sticky top-0 z-30 transition-all">
        <div className="px-6 md:px-10 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 min-w-0">
            <Link to="/essays" className="p-2 rounded-xl bg-white/5 text-gray-400 hover:text-white transition-colors shrink-0">
              <ArrowLeft size={18} />
            </Link>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        <div className="px-6 md:px-10 pt-10 pb-20 grid grid-cols-1 lg:grid-cols-12 gap-8">
